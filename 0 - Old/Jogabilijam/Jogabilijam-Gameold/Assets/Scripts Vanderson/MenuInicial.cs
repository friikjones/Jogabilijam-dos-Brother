...
public class MenuInicial : MonoBehaviour
{
    ...
    public void Jogar()//chama a tela de seleção de personagem, esta funcional
    {
        SceneManager.LoadScene(nomeCenaJogo);
    }

    public void Opcoes() //chama a cena de opções.
    {
        SceneManager.LoadScene(nomeCenaOpcoes);
    }


    public void Sair()//deve encerrar a aplicação, ainda nada acontece
    {
        Application.Quit();
    }
}