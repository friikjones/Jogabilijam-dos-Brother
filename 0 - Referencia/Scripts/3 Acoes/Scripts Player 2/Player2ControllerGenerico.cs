...
public class Player2ControllerGenerico : MonoBehaviour {
    ...
    void FixedUpdate()
    {
        Management Management = GameObject.Find("Game Manager").GetComponent<Management>();
        FimDeJogo = Management.FimDeJogo;
    ...
    void EscutaLista()
    {
        ...
        //Working:
        //Player1ControllerGenerico otherScript = GameObject.Find("Player 1").GetComponent<Player1ControllerGenerico>();
        Player2_PARA_1 otherScript = GameObject.Find("Player 1").GetComponent<Player2_PARA_1>();
